...
public class Swagger2Config
{
    ...
    public Docket api()
    {
        return new Docket(DocumentationType.SWAGGER_2)
                ...
                .apis(RequestHandlerSelectors
                              .basePackage("com.lambdaschool.javazoo"))
    ...
    {
        return new ApiInfoBuilder().title("Java Zoo")
                .description("Christian's Java Zoo")
                .contact(new Contact("Christian Bautista",
                                     "http://www.lambdaschool.com",
                                     "christian-bautista@lambdastudents.com"))
                .license("MIT")
                .licenseUrl("https://github.com/ianbautista/java-zoos/blob/master/LICENSE")
                .version("1.0.0")
                .build();
    }
}